...
#define DRV8343_FLT RPI_GPIO_P1_22		//Use Pin22/GPIO25 as input to detect DRV8343S Fault alert

// TMP275 temperature limit alert pin
#define Power_MOSFET_over_tmp_alert RPI_V2_GPIO_P1_07
...
#define PWM_INHC RPI_V2_GPIO_P1_12		// Use pin12/GPIO18 as PWM to control something else; need to set GPIO ALT FUN to 5 to use PWM
...
#define max_speed 		0.6*PWM_RANGE		//Top speed
